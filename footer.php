        ...
        <div class="grid grid-4">
                ...
                if (has_custom_logo()) {
                    ...
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="footer-logo-link">
                        <img src="<?php echo esc_url(hoplytics_get_logo_url()); ?>" alt="<?php bloginfo('name'); ?>"
                            class="footer-logo" width="150" style="margin-bottom: 1rem;">
                    </a>
                    <?php
                }
                ?>
                <p class="text-sm text-muted">
                    <?php echo esc_html(get_theme_mod('footer_tagline', get_bloginfo('description'))); ?></p>
            </div>
            ...
            <div class="footer-services">
                ...
                if (has_nav_menu('footer-services')) {
                    ...
                    <ul>
                        <li><a
                                href="<?php echo esc_url(home_url('/search-engine-optimization/')); ?>"><?php esc_html_e('SEO', 'hoplytics'); ?></a>
                        </li>
                        <li><a
                                href="<?php echo esc_url(home_url('/search-engine-marketing/')); ?>"><?php esc_html_e('Paid Ads (SEM)', 'hoplytics'); ?></a>
                        </li>
                        <li><a
                                href="<?php echo esc_url(home_url('/social-media-marketing/')); ?>"><?php esc_html_e('Social Media', 'hoplytics'); ?></a>
                        </li>
                        <li><a
                                href="<?php echo esc_url(home_url('/content-marketing-services/')); ?>"><?php esc_html_e('Content Marketing', 'hoplytics'); ?></a>
                        </li>
                    </ul>
                    <?php
                }
