 ...
 */
function hoplytics_register_cpts(): void
{
 ...
 * Register Taxonomies
 */
function hoplytics_register_taxonomies(): void
{
...
function hoplytics_render_service_meta_box($post)
{
    ...
    <select name="related_service_id" id="related_service_id" style="width:100%">
        ...
        <?php foreach ($services as $service): ?>
            <option value="<?php echo esc_attr((string) $service->ID); ?>" <?php selected($selected, $service->ID); ?>>
